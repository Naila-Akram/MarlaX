...
/**
 * Direct Sale flow — the user's fixed-price listings, read from the shared
 * store. Its own component so it can diverge from the bidding flow.
 */
const DirectSaleListings = () => {
  const listings = useListingStore(s => s.directSaleListings);
